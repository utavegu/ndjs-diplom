...
@Module({
  imports: [
    PassportModule,
    // .register({
    //   session: false, // списал из инета, хз что значит. РАЗБЕРИСЬ. И может можно будет без экспресс-сессии обойтись, если тут поставлю тру, а в мэйне верну то, что связано с пасспортом?
    // }),
    JwtModule.register({
